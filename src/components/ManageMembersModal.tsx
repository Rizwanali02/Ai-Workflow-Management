            ...
            {fetching ? (
              ...
              <div className="space-y-2">
                {filteredUsers.map((user) => (
                  <div
                    key={user._id}
                    className={`flex items-center justify-between p-3 rounded-xl border transition-all cursor-pointer ${selectedMembers.includes(user._id)
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <Avatar className="w-9 h-9">
                        ...
                        />
                        <AvatarFallback
                          className={`text-xs font-bold ${isSelected(user._id)
